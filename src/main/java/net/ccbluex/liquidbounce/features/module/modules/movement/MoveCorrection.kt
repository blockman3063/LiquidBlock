...
import net.ccbluex.liquidbounce.features.module.modules.combat.Aimbot.state
import net.ccbluex.liquidbounce.utils.MinecraftInstance.Companion.mc
import net.ccbluex.liquidbounce.value.BoolValue
import net.ccbluex.liquidbounce.utils.RotationUtils
import net.minecraft.util.MathHelper

object MoveCorrection : Module("MoveCorrection", ModuleCategory.MOVEMENT)
    private val silentFixVaule by BoolValue("Silent", true)
    var silentFix = false
    var doFix = false
